...
const rooms = [
  ...
  { id: 15, name: "Olympic Area 2", lat: 11.5610, lng: 104.9102 },
  ...
  { id: 19, name: "Siem Reap Budget", lat: 13.3550, lng: 103.8615 },
  ...
  { id: 26, name: "BKK Mini Room", lat: 11.5570, lng: 104.9290 },
  { id: 27, name: "TK Budget Room", lat: 11.5690, lng: 104.8920 },
  { id: 28, name: "Olympic Studio", lat: 11.5625, lng: 104.9120 },
  { id: 29, name: "Mean Chey 2", lat: 11.5355, lng: 104.9010 },
  { id: 30, name: "Daun Penh 2", lat: 11.5745, lng: 104.9235 },

  { id: 31, name: "SR Hostel 2", lat: 13.3566, lng: 103.8566 },
  { id: 32, name: "Angkor Stay", lat: 13.3690, lng: 103.8580 },
  { id: 33, name: "SR Apartment", lat: 13.3620, lng: 103.8625 },
  { id: 34, name: "Pub Street Stay", lat: 13.3520, lng: 103.8540 },
  { id: 35, name: "SR River Room", lat: 13.3618, lng: 103.8675 },

  { id: 36, name: "Beach Room 2", lat: 10.6100, lng: 103.5210 },
  { id: 37, name: "Otres Budget", lat: 10.5805, lng: 103.5420 },
  { id: 38, name: "Sihanouk Hostel", lat: 10.6035, lng: 103.5290 },
  { id: 39, name: "Sea View Room", lat: 10.6070, lng: 103.5175 },
  ...
  { id: 47, name: "Sen Sok Room", lat: 11.6189, lng: 104.8830 },
  { id: 48, name: "Olympic Flat", lat: 11.5630, lng: 104.9110 },
  { id: 49, name: "Mean Chey Studio", lat: 11.5360, lng: 104.9020 },
  { id: 50, name: "Daun Penh Studio", lat: 11.5750, lng: 104.9240 }
]
